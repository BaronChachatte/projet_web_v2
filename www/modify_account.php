        ...
        <div class="container">
            <form class="formulaire" action="./modify.php" method="post">
                <?php
                    ...
                    echo "<p>$user</p>";
                    echo "<input type='password' placeholder='Modifier votre mot de passe' name='password'>";
                    echo "<input type='text' placeholder='Modifier votre prénom' name='new_first_name' value='".$first_name."'>";
                    echo "<input type='text' placeholder='Modifier votre nom' name='new_name' value='".$name."'>";
                    echo "<input type='text' placeholder='Modifier votre téléphone' name='new_phone' value='".$phone."'>";
                    echo "<input type='text' placeholder='Modifier votre adresse' name='new_adresse' value='".$adresse."'>";
                    echo "<input type='text' placeholder='Modifier votre mail' name='new_mail' value='".$mail."'>";
